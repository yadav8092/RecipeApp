...
import com.chandan.recipeapp.Models.ExtendedIngredient;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("https://spoonacular.com/cdn/ingredients_100*100/"+list.get(position).image).into(holder.imageView_ingredients);
    }
